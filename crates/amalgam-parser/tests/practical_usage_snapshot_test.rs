...

{
  ...
  # IntOrString is defined as String in our generated code
  int_or_string_text | String = "80%",  # Validate it's a string
  int_or_string_check = k8s.v0.IntOrString & "80%",  # Test IntOrString accepts strings
