...
use amalgam_core::{IR, types::{Type, Field}};
use std::fmt::Write;
...
impl GoCodegen {
    ...
    fn field_to_go(&self, name: &str, field: &Field, indent_level: usize) -> Result<String, CodegenError> {
            ...
            if !module.constants.is_empty() {
                ...
                for constant in &module.constants {
                    ...
                    writeln!(output, "{}{} = {}", 
                        self.indent(1), 
                        constant.name, 
                        serde_json::to_string(&constant.value).unwrap_or_else(|_| "nil".to_string()))
                        .map_err(|e| CodegenError::Generation(e.to_string()))?;
                }
                writeln!(output, ")")
                    .map_err(|e| CodegenError::Generation(e.to_string()))?;
