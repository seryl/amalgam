...
#[test]
#[ignore] // TODO: Update to work without PackageWalkerAdapter
...
#[test]
#[ignore] // TODO: Update to work without ImportPathCalculator
fn test_version_mismatch_imports() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert_eq!(
        path,
        "../../crossplane/apiextensions.crossplane.io/crossplane/composition.ncl"
    );
    Ok(())
}
